...
import { ArrowLeft, Upload, X, Sparkles, Image as ImageIcon, CheckCircle2, AlertCircle, Loader2, Trash2 } from 'lucide-react';
...
export default function EditProduct() {
  ...
  const fetchProduct = async () => {
    try {
      ...
      console.log('Product code from DB:', product.code);
      ...
      setFormData({
        ...
        code: product.code || '', // Load code from database
  ...
  const handleRemoveImage = async () => {
    ...
    try {
      ...
      // Example: https://res.cloudinary.com/xxx/image/upload/v123456/zennara/consultations/abc.jpg
      // We need: zennara/consultations/abc
      const urlParts = formData.image.split('/');
      const uploadIndex = urlParts.findIndex(part => part === 'upload');
      
      if (uploadIndex !== -1 && uploadIndex + 2 < urlParts.length) {
        // Skip 'upload' and version number (v123456)
        ...
        await axios.delete(`${API_URL}/upload/media/${encodeURIComponent(publicId)}`, {
          headers: { Authorization: `Bearer ${token}` }
        });
      }

      // Update product in database to remove image reference
      const productData = {
        ...formData,
      ...
      await axios.put(`${API_URL}/admin/products/${id}`, productData, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Product code being sent:', productData.code);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50/30 to-cyan-50/20 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-900 text-lg font-black mb-2">Loading Product</p>
        ...
        <div className="fixed top-8 right-8 z-50 animate-slide-in-right">
          <div className="bg-white rounded-3xl shadow-2xl border border-emerald-200 overflow-hidden backdrop-blur-xl">
            <div className="flex items-center gap-4 p-6">
              ...
              <div>
                <p className="text-base font-bold text-gray-900">Product Updated!</p>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 animate-scale-in">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 bg-gradient-to-br from-red-100 to-red-200 rounded-2xl flex items-center justify-center flex-shrink-0">
                <Trash2 className="w-7 h-7 text-red-600" />
              </div>
              <div>
                <h3 className="text-xl font-black text-gray-900">Remove Image?</h3>
                <p className="text-sm text-gray-600 mt-1">This action cannot be undone</p>
              </div>
            </div>
            <p className="text-base text-gray-700 mb-8 leading-relaxed">
              The image will be permanently deleted from Cloudinary and removed from the product.
            </p>
            <div className="flex gap-3">
              <button
                onClick={() => setShowDeleteConfirm(false)}
                className="flex-1 px-6 py-4 bg-white border-2 border-gray-200 text-gray-700 text-sm font-bold rounded-2xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-300 hover:scale-105 active:scale-95"
              >
                Cancel
              </button>
              <button
                ...
                disabled={deleting}
                className="flex-1 px-6 py-4 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white text-sm font-bold rounded-2xl transition-all duration-300 hover:scale-105 active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {deleting ? (
                  <>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl md:text-3xl font-black bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">Edit Product</h1>
                  <p className="text-sm text-gray-600 font-medium">Update your product information</p>
                </div>
              </div>
            </div>
          </div>
                      ...
                      <>
                        ...
                        {formData.image && (
                          <button
                            ...
                            disabled={deleting}
                            className="absolute bottom-4 right-4 px-4 py-2 bg-white/90 hover:bg-white text-red-600 font-bold text-sm rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95 flex items-center gap-2"
                          >
                            {deleting ? (
                              <>
                                <Loader2 className="w-4 h-4 animate-spin" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all"
                  required
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all"
                  />
                  <button
                    type="button"
                    onClick={() => {
                    ...
                    className="px-4 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white text-sm font-semibold rounded-xl transition-all duration-300 hover:scale-105 active:scale-95 shadow-md hover:shadow-lg whitespace-nowrap"
                  >
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all resize-none"
                  required
                />
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    step="0.01"
                    placeholder="0.00"
                    className="w-full pl-8 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition-all"
                    required
                  />
                </div>
              </div>
