...
export default function ReturnedOrders() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50/30 flex items-center justify-center">
        <div className="text-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-orange-400/20 to-amber-400/20 blur-xl"></div>
          </div>
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50 p-8">
        <div className="max-w-md mx-auto bg-white/80 backdrop-blur-xl border border-orange-200/50 rounded-2xl p-8 shadow-lg">
          ...
          <button 
            ...
            className="w-full px-4 py-3 bg-gradient-to-r from-orange-500 to-amber-600 text-white rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-200 font-medium"
          >
            Try Again
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50/30 p-8">
      {/* Header */}
      <div className="mb-8">
